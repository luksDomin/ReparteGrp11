...
class T02_CrearGrupo {
	...
	void testCrearGrupoCP5() {
		...
		assertNotNull(grupoPrueba.getNombre()); // Comprobamos que el nombre no es nulo
		assertNotNull(grupoPrueba.getUsers()); // Comprobamos que el HashSet de usuarios del grupo no es nulo
